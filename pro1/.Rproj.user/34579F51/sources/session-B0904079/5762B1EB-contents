...
# 변수는 mpg(연비), hp(마력수)
cor(mtcars$hp, mtcars$mpg)  # -0.7761684 반비례관계
...
model1
# y_hat = -0.06823 * hp + 30.09886
summary(model1)  # p-value: 1.788e-07 < 0.05 유의함 모델 R-squared : 0.6024
...
summary(model2)   # p-value: 9.109e-12 < 0.05 유의함 모델 Adjusted R-squared:  0.8148
